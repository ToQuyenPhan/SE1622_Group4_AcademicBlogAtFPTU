        ...
        <div class="container-fluid">
            <main class="tm-main">
                ...
                <%
                    ...
                    if (listAllMajors != null) {
                        if (listAllMajors.size() > 0) {
                            int all = listAllMajors.size();
                            int index = 0;
                            for (MajorDTO major : listAllMajors) {
                %>
                ...
                <div class="delete-activity-message-popup-confirm" id="<%= index%>">
                    ...
                    <div>
                        <a href="MainController?action=DeleteMajor&majorID=<%= major.getMajorID()%>">Deactivate</a>
