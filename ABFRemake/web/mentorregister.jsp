<%-- 
    Document   : mentorrigister
    Created on : Jun 16, 2022, 10:49:46 PM
    Author     : Bat
--%>
...
<html lang="en">
    <head>
        ...
        <title>Create Mentor Register</title>
                ...
                <div class="nav-menu row">
                    ...
                    <div class="nav-link-items col-sm-3">
                        <ul class="nav-items">
                            ...
                            <li class="nav-link active"><a href="#" class="tm-nav-link">
                                    Registration
                                </a></li>  
                        </ul>
                    </div>
        ...
        <div class="tm-main">
            <div class="col-12">
                ...
                <form style="margin-top: 1rem;" action="MainController" method="POST" name="f">
                    ...
                    <div class="mb-4">
                        Certificate<input class="form-control" name="certificate" type="text" value="<%= (request.getAttribute("certificate") == null) ? "" : request.getAttribute("certificate")%>"><span id="e2"></span>                              
                    ...
                    <div class="text-right post-blog-form">
                        <div style="color: red"><%= (request.getAttribute("DOUBLE_REGISTRATRION") == null) ? "" : request.getAttribute("DOUBLE_REGISTRATRION")%> </div>
                        <input type="submit" name="action" value="Register" onclick=" return validation()"
