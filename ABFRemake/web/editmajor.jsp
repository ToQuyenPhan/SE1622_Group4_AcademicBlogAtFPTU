                    ...
                    <div class="col-12">
                        ...
                        <form action="MainController" method="POST" name="f">
                            ...
                            <div class="mb-4">                   
                                ...
                                <%
                                    MajorDTO major = (MajorDTO) request.getAttribute("MAJOR_EDIT");
                                    if (major != null) {%>
                            </div>
                            <input type="hidden" name="majorID" value="<%= major.getMajorID()%>">
                            <div class="mb-4">
                                Major Name: <input class="form-control" name="majorName" type="text" value="<%= major.getMajorName()%>">                             
                            </div>                           
