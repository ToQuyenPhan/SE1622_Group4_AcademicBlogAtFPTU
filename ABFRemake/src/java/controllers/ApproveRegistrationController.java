 ...
 */
@WebServlet(name = "ApproveRegistrationController", urlPatterns = {"/ApproveRegistrationController"})
public class ApproveRegistrationController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ApproveRegistrationController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
