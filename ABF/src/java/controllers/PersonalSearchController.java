 ...
 * @author DELL
 */
@WebServlet(name = "PersonalSearchController", urlPatterns = {"/PersonalSearchController"})
public class PersonalSearchController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = ERROR;
        try {
            String search = request.getParameter("searchPersonal");
            BlogDAO dao = new BlogDAO();
            List<BlogDTO> listAllBlogs = dao.personalSearchByTitle(search);
