...
public class MentorRegisterController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            boolean check = dao.createRegistration(userID, subjectID, date, certificate);
            if (check) {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(MentorRegisterController.class.getName()).log(Level.SEVERE, null, ex);
