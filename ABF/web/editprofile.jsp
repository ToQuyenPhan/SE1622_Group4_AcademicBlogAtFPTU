  ...
  <body>
    ...
    <div class="container-profile-page row">
        ...
        <div class="content-profile-page">
          ...
          <h2>
              Date Of Birth: <input type="date" name="dateOfBirth" value="<%= loginUser.getDateOfBirth()%>"
              
              
          </h2>
          <h2>
              Gender: <select name="fullName">
                  <option value="<%= loginUser.getGender()%>">Male</option>
                  <option value="<%= loginUser.getGender()%>">Female</option>
                  <option value="<%= loginUser.getGender()%>">Other</option>
              </select> 
          </h2>
          <h2>
          ...
          <h2>
              Address: <input type="text" name="fullName" value="<%= loginUser.getAddress()%>"
          </h2>
          <h2>
              Contact: <input type="text" name="fullName" value="<%= loginUser.getContact() %>"
          </h2>
          <h2>
              About me: <input type="text" name="fullName" value="<%= loginUser.getAboutme() %>"
          </h2>
