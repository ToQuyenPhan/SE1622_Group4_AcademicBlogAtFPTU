<%-- 
    Document   : draftblog
    Created on : Jun 19, 2022, 3:45:56 PM
    Author     : DELL
--%>
            ...
            <main class="tm-main">
                ...
                <div class="row tm-row">
                    <%
                        ...
                        List<BlogDTO> listAllBlogs = (List<BlogDTO>) request.getAttribute("LIST_ALL_DRAFT_BLOGS");
                        if (listAllBlogs != null) { //chỉ hiển thị khi người dùng đã đăng nhập
                            if (listAllBlogs.size() > 0) {
                                for (BlogDTO blog : listAllBlogs) {
                                    if (loginUser.getUserID() == blog.getUserID()) {
                    %> 
                    <article class="col-12 col-md-6 tm-post">
                        ...
                        <div class="d-flex justify-content-between">
                            <span><%= blog.getNumberOfComments()%></span>
